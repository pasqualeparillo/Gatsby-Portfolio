...
export default function AboutContent() {
  ...
  return (
    <AnimatePresence>
      {aboutActive && (
        <div className="lg:inline-flex flex flex-1 flex-wrap">
          ...
          <div className="lg:w-1/2 w-full min-h-screen bg-white flex flex-col">
            <div className="flex flex-col justify-center align-middle lg:pl-20 pl-4 lg:pr-20 pr-4 pb-12 w-full flex-1">
              <div className="flex w-full justify-center items-center relative">
                <motion.div
                  className="lg:h-40 h-26 lg:w-40 w-26 bg-black rounded-full absolute overflow-hidden z-40"
                  variants={variant}
                  animate="first"
                ></motion.div>

                <motion.div
                  className=" lg:h-48 lg:w-48 h-32 w-32 bg-black z-40 absolute overflow-hidden flex items-center"
                  variants={variantTwo}
                  animate="first"
                >
                  <motion.div
                    className="lg:h-40 h-26 lg:w-40 w-26 bg-white rounded-full z-50 absolute ml-4"
