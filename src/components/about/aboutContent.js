	...
	return (
		<AnimatePresence>
			<motion.div
				...
				animate="animation"
				exit="exit"
				key={pageLocation === '/about' ? true : false}
				...
				<div className="pb-24 flex flex-col">
					<div className="flex flex-col flex-wrap w-full ">
						<div className="flex flex-col w-8/12 pb-24">
							...
							<p className="text-white font__work-sans text-2xl tracking-wide leading-chill break-words">
								...
								behavioural patterns into repeatable investment strategies following a strict set of
								rules.
							</p>
						</div>
					</div>
					...
					<div className="flex flex-wrap w-full mb-24">
						<div className="w-5/12 flex flex-col border-t border-b border-gray-1100 pr-12 pt-16 pb-24">
							...
							<p className="text-gray-800 font__work-sans text-sm w-3/4 tracking-wide leading-chill pb-6 break-words">
								Attentive observation, unambiguous structure and out-of-the box thinking are at the
								heart of White Square’s investment process. It draws on a combination of insights gained
								from quantitative analysis, fundamental research as well as cognitive and behavioural
						...
						<div className="w-7/12 flex flex-col border-t border-l border-b border-gray-1100 pl-16 pt-16 pb-16">
							...
							<p className="text-gray-800 font__work-sans text-sm w-3/4 tracking-wide leading-chill pb-6 break-words">
								...
								constantly further its processes, and continuous feedback mechanisms furthering learning
								and improvement are built into its methods.
							</p>
						</div>
					</div>
				</div>
