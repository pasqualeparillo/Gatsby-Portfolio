	...
	return (
		<div className="z-50 fixed left-0 bottom-0 ">
			<MediaQuery minWidth={992}>
				...
				>
					<div style={{ height: '11vw', width: '11vw' }} className="fixed bottom-0 left-0">
						<div
						...
						>
							<div className="w-1/2 flex justify-center items-center">
								<p className="text-white font-gray-1000 font-black text-xs font__work-sans ">M</p>
							</div>
							<div className="w-1/2 flex justify-center items-center">
								<p className="text-white font-gray-1000 font-black text-xs font__work-sans ">E</p>
							</div>
							<div className="w-1/2 flex justify-center items-center">
								<p className="text-white font-gray-1000 font-black text-xs font__work-sans ">N</p>
							</div>
							<div className="w-1/2 flex justify-center items-center">
								<p className="text-white font-gray-1000 font-black text-xs font__work-sans ">U</p>
							</div>
						</div>
					</div>
				</motion.div>
